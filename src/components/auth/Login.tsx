...
import svgPaths from "../../imports/svg-jbniekk9lz";
...
function Title() {
  return (
    <div className="flex flex-col gap-1 items-center justify-center w-full" data-name="title">
      <h1 className="font-['Coiny',_sans-serif] text-4xl text-black">Login</h1>
...
export function Login({ onSubmit, onForgotPassword, error, onClearError }: LoginProps) {
        ...
        <div className="flex-1 flex items-center justify-center px-4 py-8">
          ...
          <div className="flex flex-col w-full max-w-md space-y-4">
            ...
            <div className="flex flex-col gap-4 mt-6">
              ...
              >
                <span className="font-['Inter',_sans-serif] font-medium text-base text-white">Login</span>
              </button>
              
              <div className="flex items-center justify-center font-['Inter',_sans-serif] font-normal text-base text-black">
                <button
                  type="button"
                  onClick={onForgotPassword}
                  className="underline hover:no-underline bg-transparent border-none cursor-pointer"
                >
                  Forgot password
                </button>
              </div>
