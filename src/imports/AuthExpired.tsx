import svgPaths from "./svg-v92ahxecnf";
...
function Delete() {
  return (
    <div className="absolute bg-[rgba(0,0,0,0)] box-border content-stretch flex gap-[8px] items-center justify-center p-[16px] right-0 rounded-[50px] size-[56px] top-0" data-name="delete">
...
export default function AuthExpired() {
  return (
    <div className="bg-white relative rounded-[24px] size-full" data-name="auth #expired">
      <div className="flex flex-col items-center relative size-full">
        <div className="box-border content-stretch flex flex-col gap-[24px] items-center pb-[40px] pt-[64px] px-[40px] relative size-full">
          <Icon />
          <Title />
          <WebButton />
          <Delete />
