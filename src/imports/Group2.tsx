import svgPaths from "./svg-jbniekk9lz";
...
function Title() {
  return (
    <div className="content-stretch flex flex-col gap-[4px] items-center justify-center not-italic relative shrink-0 w-full" data-name="title">
      <p className="font-['Coiny:Regular',_sans-serif] leading-[normal] relative shrink-0 text-[40px] text-black text-nowrap whitespace-pre">Login</p>
    ...
    <div className="bg-[#007aff] h-[56px] relative rounded-[50px] shrink-0 w-full" data-name="web_Button">
      <div className="flex flex-row items-center justify-center relative size-full">
        <div className="box-border content-stretch flex gap-[8px] h-[56px] items-center justify-center p-[16px] relative w-full">
          <p className="font-['Inter:Medium',_sans-serif] font-medium leading-[24px] not-italic relative shrink-0 text-[16px] text-center text-nowrap text-white whitespace-pre">Login</p>
        </div>
      </div>
    </div>
  );
...
function SubActions() {
  return (
    <div className="content-stretch flex font-['Inter:Regular',_sans-serif] font-normal items-center justify-between leading-[24px] not-italic relative shrink-0 text-[16px] text-black text-center text-nowrap underline w-full whitespace-pre" data-name="subActions">
      <p className="[text-decoration-skip-ink:none] [text-underline-position:from-font] decoration-solid relative shrink-0">Create admin</p>
      <p className="[text-decoration-skip-ink:none] [text-underline-position:from-font] decoration-solid relative shrink-0">Forgot password</p>
    </div>
  );
}
...
function Action() {
  return (
    <div className="content-stretch flex flex-col gap-[16px] items-start relative shrink-0 w-full" data-name="action">
      <WebButton />
      <SubActions />
    </div>
  );
...
function Main() {
  return (
    <div className="absolute box-border content-stretch flex flex-col h-[792px] items-center justify-center left-[13px] px-0 py-[40px] top-[8px] w-[1200px]" data-name="main">
      <AuthSignup />
    </div>
  );
}
